                ...
                <nav id="site-navigation" class="main-menu nav primary flex items-center justify-between">
                    <div class="menu-primary-container">
                        ...
                        <ul class="primary-menu header-font medium smooth gray h5 list-reset">
                            ...
                            <li class="tag__filter_item"><button class="flex category-toggle dev" href="#dev" type="button" data-filter="sticker"><span id="dev"><img src="https://s3-us-west-1.amazonaws.com/cdn.swag.space/assets/emojis/1f60d.png" width="16"/></span>&nbsp; Stickers</button></li>
                            <li class="tag__filter_item"><button class="flex category-toggle design" href="#design" type="button" data-filter="apparel"><span id="design"><img src="https://s3-us-west-1.amazonaws.com/cdn.swag.space/assets/emojis/1f455.png" width="16"/></span>&nbsp; Apparel</button></li>
                            <li class="tag__filter_item"><button class="flex category-toggle tech" href="#tech" type="button" data-filter="accessories"><span id="tech"><img src="https://s3-us-west-1.amazonaws.com/cdn.swag.space/assets/emojis/1f6e0.png" width="16"/></span>&nbsp; Accessories</button></li>
                        </ul>
